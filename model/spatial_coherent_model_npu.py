...
if __name__ == "__main__":
    ...
    model_in = Trans(cv2.imread("/data2/JM/MEAD/M003/align_img/sad/001/000000.jpg")).unsqueeze(0).repeat(2, 1, 1, 1).npu()
    model_out = Trans(cv2.imread("/data2/JM/MEAD/M003/align_img/sad/001/000010.jpg")).unsqueeze(0).repeat(2, 1, 1, 1).npu()
